    ...
    <section id="menu-teaser" className="py-16 bg-gradient-to-r from-nepal-blue to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
            ...
            <button
                ...
                className="bg-white text-nepal-blue px-8 py-3 rounded-full text-lg font-bold hover:bg-gray-100 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                See Full Menu
            </button>
        </div>
    </section>
